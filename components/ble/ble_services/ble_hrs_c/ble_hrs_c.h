 ...
 */
 #define HEARTRATE_MAX_CHARACTORS  8
struct ble_hrs_c_s
{
    uint16_t                conn_handle;      /**< Connection handle as provided by the SoftDevice. */
    uint16_t                hrm_cccd_handle[HEARTRATE_MAX_CHARACTORS];  /**< Handle of the CCCD of the Heart Rate Measurement characteristic. */     
    uint16_t                hrm_handle[HEARTRATE_MAX_CHARACTORS];       /**< Handle of the Heart Rate Measurement characteristic as provided by the SoftDevice. */
